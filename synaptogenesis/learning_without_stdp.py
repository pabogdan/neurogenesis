...
source_pop = sim.Population(N_layer, model, cell_params, label="TARGET_POP")
...
rates = generate_multimodal_rates([[1, 256 // 4], [1, (3 * 256) // 4]], grid,
                                  sigma_stim=2.5, f_peak=args.f_peak)
ssp = sim.Population(N_layer,
...
if args.filename:
    ...
    filename = "learning_without_stdp_results" + str(suffix)
